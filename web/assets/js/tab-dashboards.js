...
(function () {
  // THIS IS GLOBAL VARIABLE DECLARED IN config.js START
  ...
  // THIS IS GLOBAL VARIABLE DECLARED IN config.js END
  ...
  // --------------------------------------------------------------------
//   var seriesData = [85, 0, 50, 50];
//   var totalSeries = seriesData.reduce(function(acc, currentValue) {
...
//         type: 'donut'
//       },
//       labels: ['Visa', 'Sports', 'Debit', 'MasterCard'],
//       series: seriesData,
