...
$(function () {
  ...
  var dt_user_table = $('.datatables-terminal-list'),
    select2 = $('.select2'),
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      // ajax: webPath+'tab-all-terminals/table',
      serverSide: true,
      ajax: {
				url: webPath+'tab-all-terminals/table',
				type: 'POST',
      },
      columns: [
        { data: 'terminal_id' },
              ...
              '<div class="d-inline-block text-nowrap">' +
                '<div class="dropdown">' +
                  ...
                  '<div class="dropdown-menu dropdown-menu-end" aria-labelledby="actionsDropdown">' +
                    '<a class="dropdown-item" href="#">Assign TID</a>' +
      ...
      buttons: [
        {
          ...
          buttons: [
            ...
            },
            {
              ...
              filename: `Terminal_${timestampnow}`,
              className: 'dropdown-item',
              exportOptions: {
                columns: [1, 2, 3, 4, 5, 6, 7],
                format: {
            ...
            },
            {
              ...
              action: function (e, dt, button, config) {
                fetch(webPath + 'tab-all-terminals/table.csv', {
                    method: 'GET',
                    headers: {
                ...
                .then(blob => {
                  ...
                  const filename = `Terminal_Report_${timestampnow}.csv`;
